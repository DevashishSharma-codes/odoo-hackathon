...
import { Plane, LayoutDashboard, Map, Search, Activity, DollarSign, Package, FileText, User, BarChart3, Plus } from 'lucide-react';
...
export function Layout() {
  ...
  const navItems = [
    ...
    { path: '/cities', icon: Search, label: 'Explore Cities' },
